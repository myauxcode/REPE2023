        ...
        // Pregunta 1R de la forma como pide mollo

        public bool EsSimbolo(char c)
        {
            // Aquí puedes agregar cualquier otro símbolo que desees invertir
            return c == '!' || c == '¡' || c == '?' || c == '¿' || c == '@' || c == '#' || c == '*' || c == '{' || c == '}' || c == '[' || c == ']' || c == '+' || c == '-' || c == '.';
        }
        public string ejercicio2R(string s)
        {
        ...
        private void ejercicio2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
           // textBox3.Text = string.Concat(ejercicio2((textBox1.Text)));
            textBox3.Text = string.Concat(ejercicio2R((textBox1.Text)));
